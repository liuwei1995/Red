...
public class QQ_6_5_7_Presenter extends QQPresenter {

    private static final String TAG = "Wechat_6_5_7_Presenter";

    private AccessibilityService accessibilityService;

    public QQ_6_5_7_Presenter(AccessibilityService accessibilityService) {
        ...
        public void onReceive(Context context, Intent intent) {
            if (remoteViews != null)
                if (intent.getAction().equals(open)) {//开
                    ...
                    remoteViews.setTextViewText(R.id.tv_Auxiliary_function, "红包辅助功能已开启");
                    ...
                    remoteViews.setTextViewText(R.id.tv_Auxiliary_function, "红包辅助功能已关闭");
                }
            mHander.sendEmptyMessage(0);
        }
