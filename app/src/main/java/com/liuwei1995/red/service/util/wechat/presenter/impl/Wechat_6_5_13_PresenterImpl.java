...
public class Wechat_6_5_13_PresenterImpl extends WechatPresenterImpl {

    private static final String TAG = Wechat_6_5_13_PresenterImpl.class.getSimpleName();

    /**关闭按钮id*/
    private static final String Close_button = "com.tencent.mm:id/bh8";

    /**红包弹窗关闭按钮*/
    private static final String Close_button_red_popupwindow = "com.tencent.mm:id/bmu";

    /**
     * 红包控件id
     */
    private static final String ID_OPEN_RED_ENVELOPE_CONTROL = "com.tencent.mm:id/bp6";

    /***红包详情返回按钮*/
    private static final String return_LinearLayout_red_details = "com.tencent.mm:id/hc";


    public Wechat_6_5_13_PresenterImpl(AccessibilityService accessibilityService) {
